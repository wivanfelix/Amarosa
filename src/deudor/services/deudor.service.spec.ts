...
describe('DeudorService', () => {
  ...
  it('should create a deudor', async () => {
    ...
    expect(result.localizable).toBe(1); // Verifica que sea localizable por defecto
  });
  ...
  it('should find one deudor by id', async () => {
    ...
    const result = await service.findOne(createdDeudor.Id_Deudor);
  ...
  it('should update a deudor', async () => {
    ...
    const result = await service.update(createdDeudor.Id_Deudor, updateDto);
  ...
  it('should delete a deudor', async () => {
    ...
    const result = await service.remove(createdDeudor.Id_Deudor);
    expect(result).toBeDefined();
  ...
  it('should declare deudor as ilocalizable', async () => {
    ...
    const result = await service.declararIlocalizable(createdDeudor.Id_Deudor);
