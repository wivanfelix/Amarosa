...
describe('CreditoController', () => {
  ...
  it('should find one credito by id', async () => {
    ...
    const result = await controller.findOne(credito.Id_Credito.toString());
  ...
  it('should update credito estado to riesgoso', async () => {
    ...
    const result = await controller.declararRiesgoso(
      credito.Id_Credito.toString(),
    );
  ...
  it('should update credito estado to irrecuperable', async () => {
    ...
    const result = await controller.declararIrrecuperable(
      credito.Id_Credito.toString(),
    );
  ...
  it('should delete a credito', async () => {
    ...
    const result = await controller.remove(credito.Id_Credito.toString());
    expect(result).toBeDefined();
